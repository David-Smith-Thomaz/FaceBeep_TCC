...
@Injectable()
export class StatusDoUsuarioService extends ServiceBase {

    private _form : FormGroup;

    constructor(private api: ApiService<any>,private serviceFields: StatusDoUsuarioServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('StatusDoUsuario', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('StatusDoUsuario').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('StatusDoUsuario').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('StatusDoUsuario').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if (model.statusDoUsuarioId) {
            return this.api.setResource('StatusDoUsuario').put(model);
        }

        return this.api.setResource('StatusDoUsuario').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('StatusDoUsuario').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('StatusDoUsuario').export(filters);
    }
}
