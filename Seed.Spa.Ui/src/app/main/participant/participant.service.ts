...
export class ParticipantService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: ParticipantServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('Participant', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('Participant').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('Participant').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('Participant').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if (model.participantId) {
            return this.api.setResource('Participant').put(model);
        }

        return this.api.setResource('Participant').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('Participant').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('Participant').export(filters);
    }
}
