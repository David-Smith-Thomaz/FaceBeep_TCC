...
export class RegisterService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: RegisterServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('Register', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('Register').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('Register').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('Register').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if (model.registerId) {
            return this.api.setResource('Register').put(model);
        }

        return this.api.setResource('Register').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('Register').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('Register').export(filters);
    }
}
