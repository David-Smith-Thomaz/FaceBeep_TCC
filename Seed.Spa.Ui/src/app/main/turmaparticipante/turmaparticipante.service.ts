...
@Injectable()
export class TurmaParticipanteService extends ServiceBase {

    private _form : FormGroup;

    constructor(private api: ApiService<any>,private serviceFields: TurmaParticipanteServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('TurmaParticipante', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('TurmaParticipante').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('TurmaParticipante').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('TurmaParticipante').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if (model.turmaParticipanteId) {
            return this.api.setResource('TurmaParticipante').put(model);
        }

        return this.api.setResource('TurmaParticipante').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('TurmaParticipante').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('TurmaParticipante').export(filters);
    }
}
