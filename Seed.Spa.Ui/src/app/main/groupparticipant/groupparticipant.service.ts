...
@Injectable()
export class GroupParticipantService extends ServiceBase {

    private _form : FormGroup;

    constructor(private api: ApiService<any>,private serviceFields: GroupParticipantServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('GroupParticipant', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('GroupParticipant').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('GroupParticipant').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('GroupParticipant').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if (model.groupParticipantId) {
            return this.api.setResource('GroupParticipant').put(model);
        }

        return this.api.setResource('GroupParticipant').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('GroupParticipant').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('GroupParticipant').export(filters);
    }
}
