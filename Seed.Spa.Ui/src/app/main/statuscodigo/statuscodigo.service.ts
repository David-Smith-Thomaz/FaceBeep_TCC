...
@Injectable()
export class StatusCodigoService extends ServiceBase {

    private _form : FormGroup;

    constructor(private api: ApiService<any>,private serviceFields: StatusCodigoServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('StatusCodigo', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('StatusCodigo').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('StatusCodigo').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('StatusCodigo').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if (model.statusCodigoId) {
            return this.api.setResource('StatusCodigo').put(model);
        }

        return this.api.setResource('StatusCodigo').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('StatusCodigo').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('StatusCodigo').export(filters);
    }
}
