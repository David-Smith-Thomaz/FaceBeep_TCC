...
@Injectable()
export class FotoDoParticipanteService extends ServiceBase {

    private _form : FormGroup;

    constructor(private api: ApiService<any>,private serviceFields: FotoDoParticipanteServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    initVM(): ViewModel<any> {
        ...
        return new ViewModel({
            ...
            actionTitle: "FotoDoParticipante",
            actionDescription: "",
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('FotoDoParticipante', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('FotoDoParticipante').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('FotoDoParticipante').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('FotoDoParticipante').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if (model.fotoDoParticipateId) {
            return this.api.setResource('FotoDoParticipante').put(model);
        }

        return this.api.setResource('FotoDoParticipante').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('FotoDoParticipante').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('FotoDoParticipante').export(filters);
    }
}
