...
@Injectable()
export class StatusRegisterService extends ServiceBase {

    private _form : FormGroup;

    constructor(private api: ApiService<any>,private serviceFields: StatusRegisterServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('StatusRegister', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('StatusRegister').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('StatusRegister').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('StatusRegister').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if (model.statusRegisterId) {
            return this.api.setResource('StatusRegister').put(model);
        }

        return this.api.setResource('StatusRegister').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('StatusRegister').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('StatusRegister').export(filters);
    }
}
