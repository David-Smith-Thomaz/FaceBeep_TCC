...
@Component({
    selector: 'app-statususer-edit',
    templateUrl: './statususer-edit.component.html',
    styleUrls: ['./statususer-edit.component.css'],
})
export class StatusUserEditComponent extends ComponentBase implements OnInit, OnDestroy {
