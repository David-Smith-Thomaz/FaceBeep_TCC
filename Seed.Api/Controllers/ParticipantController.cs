...
namespace Seed.Api.Controllers
{
    ...
    public class ParticipantController : Controller
    {
		...
		public async Task<IActionResult> Get(int id, [FromQuery]ParticipantFilter filters)
		{
            ...
            try
            {
				if (id.IsSent()) filters.ParticipantId = id;
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]ParticipantDtoSpecialized dto)
        {
            var result = new HttpResult<ParticipantDto>(this._logger);
            try
            {
            ...
            {
                var responseEx = result.ReturnCustomException(ex,"Seed - Participant", dto, new ErrorMapCustom());
				return responseEx;
            }
        }
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody]ParticipantDtoSpecialized dto)
        {
            var result = new HttpResult<ParticipantDto>(this._logger);
            try
            {
        ...
        [HttpDelete]
        [HttpDelete("{id}")]
        public async Task<IActionResult> Delete(int id, ParticipantDto dto)
        {
            var result = new HttpResult<ParticipantDto>(this._logger);
            try
            {
				if (id.IsSent()) dto.ParticipantId = id;
