...
namespace Seed.Api.Controllers
{
    ...
    public class SampleTypeMoreController : Controller
    {
        ...
        public SampleTypeMoreController(ISampleTypeRepository rep, ISampleTypeApplicationService app, ILoggerFactory logger, EnviromentInfo env,CurrentUser user)
        {
            this._rep = rep;
            this._app = app;
        ...
        public async Task<IActionResult> Get([FromQuery]SampleTypeFilter filters)
        {
            ...
            try
            {
				...
				if (!this._user.GetClaims().GetTools().VerifyClaimsCanRead("SampleType"))
                {
            ...
            {
                var responseEx = result.ReturnCustomException(ex,"Seed - SampleType", filters, new ErrorMapCustom());
				return responseEx;
            }
        }
        ...
        public async Task<IActionResult> Post([FromBody]IEnumerable<SampleTypeDtoSpecialized> dtos)
        {
            ...
            {
                var responseEx = result.ReturnCustomException(ex,"Seed - SampleType", dtos, new ErrorMapCustom());
				return responseEx;
            }
